    ...
    public class EmployeeRepository
    {
        ...
        */
        ...
        public bool AddEmployee(EmployeeModel model) //insert record to the table
        {
            ...
            try
            {
                ...
                {
                    SqlCommand command = new SqlCommand("dbo.payroll_service", this.connection);   //Creating a stored Procedure for adding employees into database
        ...
        */
        public double UpdatedSalaryFromDatabase(string EmployeeName)
        {
            ...
            string cconnectionString = @"Data Source=(localdb)\ProjectModels;Initial Catalog=master;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False"; //Specifying the connection string from the sql server connection.
